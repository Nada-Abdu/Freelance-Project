    ...
    <div class="col-lg-3 col-md-6 portfolio-item filter-web">
        ...
        <!--
          ...
          <div data-aos="fade-up" style="padding-top:20px; text-align:center">
            <button type="button" id="more" class="btn btn-outline-info" onclick="window.location.href='servicesDeveloper.php'">More Services</button>
          </div>
        </div>
...
?>
        ...
        <!--
          ...
          <div style="padding-top:20px; text-align:center;">
            <button type="button" id="more" class="btn btn-outline-info" onclick="window.location.href='blogsDeveloper.php'">More Blogs</button>
          </div>
