    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        ...
        <li><a class="nav-link scrollto" href="#hero">Home</a></li>
          ...
          <li><a class="getstarted scrollto" href="handleSignUp_Form.php">Get Started</a></li>
        </ul>
    ...
    <div class="col-lg-3 col-md-6 portfolio-item filter-web">
        ...
        <!--
          ...
          <div data-aos="fade-up" style="padding-top:20px; text-align:center">
            <button type="button" id="more" class="btn btn-outline-info" onclick="window.location.href='handleSignUp_Form.php'">More Services</button>
          </div>
        </div>
...
?>
        ...
        <!--
          ...
          <div style="padding-top:20px; text-align:center;">
            <button type="button" id="more" class="btn btn-outline-info" onclick="window.location.href='handleSignUp_Form.php'">More Blogs</button>
          </div>
